...
export const  PokeApiPokemons = () => {
  ...
  return (
    ...
    <div className='mx-auto max-w-[75%] text-center relative bg-black '>
            <h1 className='text-4xl font-bold mb-8 mt-2 bg-red-600'>Usando UseEffect para realizar un fetch de la api gitHub</h1>
            {loading ? (<Spinner/>) : (
