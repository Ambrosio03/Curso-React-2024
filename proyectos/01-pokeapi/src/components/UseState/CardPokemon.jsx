  ...
  return (
    <div className='relative flex w-80 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md my-5 '>
        ...
        <div className='p-6 pt-0'>
          <button className='select-none rounded-lg bg-blue-500 py-3 px-3 text-center align-middle font-sans text-sm font-bold uppercase text-white shadow-md shadow-blue-800/20 transition-all hover:shadow-lg hover:shadow-blue-800/50'>Informacion</button>
        </div>
    </div>
